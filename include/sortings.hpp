...
inline void selection_sort(std::vector<int>& arr, bool swaponce=false) { 
...
inline std::vector<int> merge(std::vector<int>& vet1, std::vector<int>& vet2) {
...
inline void merge_sort_main(std::vector<int>& arr) {
	// printf("merge sort: ");
...
inline int find_greatest(std::vector<int>& arr) {
	int greatest = arr[0];
...
inline int find_2ndgreatest(std::vector<int>& arr) {
	int greatest = arr[0];
...
inline int find_nthgreatest(std::vector<int>& arr, int n) {
	std::vector<int> arr_sorted = arr;

	merge_sort(arr_sorted); // O(n log n)
