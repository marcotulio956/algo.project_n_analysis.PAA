...
public:
	...
	static void selection_sort(std::vector<int>& arr, bool swaponce=false) { 
	...
	static std::vector<int> merge(std::vector<int>& vet1, std::vector<int>& vet2) {
	...
	*/
	...
	static void merge_sort_main(std::vector<int>& arr) {
		// printf("merge sort: ");
	...
	static int find_greatest(std::vector<int>& arr) {
		int greatest = arr[0];
	...
	static int find_2ndgreatest(std::vector<int>& arr) {
		int greatest = arr[0];
	...
	static int find_nthgreatest(std::vector<int>& arr, int n) {
